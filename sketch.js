//if you click the sweet spots just right, it will go through all the rooms
//although i couldnt get it to go from opening the chest back to the treasure romm
...
function mousePressed() {
    ...
    if (boxTres == true && endlessHallL == false && endlessHallR == false && libDoor == false && finish == false && treasureRoom == false && items == false && dist(mouseX, mouseY, boxX, boxY) <= boxD) {
        createCanvas(1000, 600)
        background(125)
        textSize(65)
        text('You Found the Treasure', 20, 65)
        text('You Recieve:', 100, 180)
        text('300 Gold and a Key', 100, 250)
    ...
    if (items == true && endlessHallL == false && endlessHallR == false && libDoor == false && finish == false && treasureRoom == false && boxTres == true && dist (mouseX, mouseY, endX, endY) > endD) {
        createCanvas(1000, 600);
        background(treasure, 0, 0);
    ...
    if ( libDoor == true && endlessHallR == true && treasureRoom == false && endlessHallL == false && items == false && finish == false && boxTres == false && dist (mouseX, mouseY, libDoorX, libDoorY) < libDoorD) {
        createCanvas(1000, 600)
  ...
  if (finish == true && endlessHallR == true && endlessHallL == false && libDoor == true && treasureRoom == false && items == false && boxTres == false && dist (mouseX, mouseY, endDoorX, endDoorY) < endDoorD) {
      createCanvas( 1000, 600)
      background(50)
      textSize(85)
      fill(0)
      text( 'You Did It!', 0, 200)
  }
